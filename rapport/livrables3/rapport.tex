...
\end{lstlisting}
		\section{Fonction de collage des images}%Elie
		        ...
		        Il y a deux cas de figure, soit les décalages en abscisse et en ordonnées sont positifs, soit le décalage en abscisse est positif et celui en ordonnée négatif.
