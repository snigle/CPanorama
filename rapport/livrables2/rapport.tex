...
\end{lstlisting}
		...
		\section{Convolution \cite{wikiConvo} } 
			...
			Les filtres sont récupérés en début de fonction, une erreur est générées si le filtre n'est pas correct, c'est à dire si le fichier texte comporte caractères autres que des chiffres ou nombres ou s'il n'y a pas assez de coefficients.
